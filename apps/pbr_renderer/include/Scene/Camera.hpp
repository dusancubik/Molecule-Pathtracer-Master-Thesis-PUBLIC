 ...
 *
 *  Description:
 *  The Camera class represents a camera, handling its position, orientation based on user's mouse movement.
 *  The Camera class is based on the implementation and concepts from LearnOpenGL's Camera tutorial
